		...
		content += `<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" >
						<div class="sales-item">
							<figure class="home-sales-img">
								<a href="tour_detail.html?id=${element.tourId}" title="">
							...
							<div class="home-sales-text">
								<div class="home-sales-name-places">
									<div class="home-sales-name">
										<a href="tour_detail.html?id=${element.tourId}" title="">${element.tourName}</a>
									</div>
								</div>
								<hr class="hr">
								<div class="price-box">
		...
		success: function (check) {
			if (check) {
				...
				if (getCookie('role') == "ROLE_USER") {
					document.querySelector(".has-account a").href = 'views/userInfo.html';
				}
				else {
					document.querySelector(".has-account a").href = 'admin/adminInfo.html';
				}
			}
			else {
